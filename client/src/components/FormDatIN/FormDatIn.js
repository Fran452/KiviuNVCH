...
function FormDatIn({addIndicador, setAddIndicador, fetchIndicadores, setLoading, setError, setIndicadores}) {
    ...
    const newMetrica = async (id) => {
        ...
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/dateIn/newMetrica`, {
                method: "POST",
                headers: {
    ...
    const handleSendData = async () => {
        ...
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/dateIn/newIndicador`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
