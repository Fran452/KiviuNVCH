...
function Tareas() {
  ...
  const handleDeleteCiclo = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/plan-accion/deleteCiclos`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteTarea = async () => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/plan-accion/deleteTask`, {
        method: "PUT",
        headers: {
            "Content-Type": "application/json"
        },
  ...
  const fetchSubtareasById = async (id) => {
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/plan-accion/viewSubTask`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
  ...
  const handleDragDrop = async (results) => {
    ...
    if(type === 'group'){
      ...
      try {
        const res = await fetch(`${process.env.REACT_APP_API_URL}/apis/plan-accion/moveTask`, {
          method: "PUT",
          headers: {
              "Content-Type": "application/json"
          },
