...
function DatIN() {
  ...
  const fetchIndicadores = async () => {
    try {
      const res = await fetch("http://localhost:3040/apis/dateIn", {
        method: "POST",
        headers: {
  ...
  const handleShowIndicador = async (id) => {
    try {
      ...
      const res = await fetch("http://localhost:3040/apis/dateIn/ultimas3Metricas", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
  ...
  const handleDeleteIndicador = async () => {
    ...
    try {
      const res = await fetch("http://localhost:3040/apis/dateIn/deleteIndicador", {
        method: "PUT",
        headers: {
            "Content-Type": "application/json"
        },
