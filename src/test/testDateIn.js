...
const controlador = {
    ...
    testGenerico: async (req,res) => {
        ...
        let testViewIndicadoresJSON = await fetch("http://164.92.77.143:3040/test/dateIn/viewIndicador",{
                method:'GET',
                headers: {
        ...
        let testNewIndicadoresJSON = await fetch("http://164.92.77.143:3040/test/dateIn/newIndicador",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
        ...
        let testEditIndicadoresJSON      = await fetch("http://164.92.77.143:3040/test/dateIn/editIndicador",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
        ...
        let testDeleteIndicadoresJSON = await fetch("http://164.92.77.143:3040/test/dateIn/deleteIndicador",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
        ...
        let testNewMetricaJSON = await fetch("http://164.92.77.143:3040/test/dateIn/newMetrica",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
        ...
        let testEditMetricaJSON = await fetch("http://164.92.77.143:3040/test/dateIn/editMegrica",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
        ...
        let testView3MetricaJSON = await fetch("http://164.92.77.143:3040/test/dateIn/ultimasTresMetricas",{
            method:'GET',
            headers: {
                "Content-Type": "application/json"
            }
   ...
   fechaBlue.setDate(fechaBlue.getDate() + 2);
    ...
    fetch('http://164.92.77.143:3040/apis/dateIn',{
        method:'POST',
        headers: {
            "Content-Type": "application/json"
        },
    ...
    newindicador: async (req,res) => {
        let resultadoTest = {};
        fetch('http://164.92.77.143:3040/apis/dateIn/newIndicador',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    editIndicadores: async (req,res) => {
        ...
        let modificacionApisJSON = await fetch('http://164.92.77.143:3040/apis/dateIn/editIndicador',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    deleteIndicadores: async (req,res) => {
        ...
        let apisEliminadoJSON = await fetch('http://164.92.77.143:3040/apis/dateIn/deleteIndicador',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    newMetrica: async (req,res) => {
        ...
        let apisJSON = await fetch('http://164.92.77.143:3040/apis/dateIn/newMetrica',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    editMetrica: async (req,res) => {
        ...
        let apisEditMetricaJSON = await fetch('http://164.92.77.143:3040/apis/dateIn/editMegrica',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    ultimasTresMetricas: async (req,res) => {
        ...
        // correr api
        let apisEnvio3MetricasJSON = await fetch('http://164.92.77.143:3040/apis/dateIn/ultimas3Metricas',{
            method:'POST',
            headers: {
                "Content-Type": "application/json"
            },
